    ...
    <aside className="w-64 min-h-screen flex flex-col shrink-0" style={{ background: 'linear-gradient(180deg, #0f172a 0%, #1e1b4b 100%)' }}>
      ...
      <div className="px-6 py-6 border-b border-white/10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-white font-bold text-base tracking-tight">InstaPro CRM</h1>
      ...
      <div className="px-5 py-4 border-t border-white/10">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-full bg-indigo-600/40 flex items-center justify-center">
            <span className="text-xs font-bold text-indigo-300">IP</span>
          </div>
          <div>
            <p className="text-white text-xs font-medium">InstaPro CRM</p>
            <p className="text-slate-500 text-xs">Gestión de proyectos</p>
          </div>
        </div>
      </div>
    </aside>
